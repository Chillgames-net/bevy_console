...
impl Default for ConsoleConfig {
    fn default() -> Self {
        Self {
            ...
            input_border_color: Color::srgb(1.0, 0.8, 0.0),
            input_text_color: Color::WHITE,
            input_ghost_color: Color::srgba(1.0, 1.0, 1.0, 0.30),
            input_prefix: "\u{25b6} ".to_string(),

            dropdown_bg: Color::srgba(0.10, 0.10, 0.10, 0.97),
            dropdown_border_color: Color::srgb(0.4, 0.32, 0.0),
            dropdown_item_divider_color: Color::srgba(1.0, 1.0, 1.0, 0.06),
            dropdown_padding_h: 10.0,
            dropdown_padding_v: 5.0,
            dropdown_text_color: Color::srgb(0.65, 0.65, 0.65),
            dropdown_highlight_bg: Color::srgba(1.0, 0.8, 0.0, 0.12),
            dropdown_highlight_text_color: Color::srgb(1.0, 0.9, 0.5),
